...
def main():
   ...
   ### setup loss function
    ...
    if args.admm_train:
        ...
        output_dir = '/data/shanglin/'+args.optimization+'_train/timm_model'
        ...
        for i in range(args.rho_num):
            ...
            for epoch in range(1, args.epochs + 1):
                ...
                if output_dir is not None:
                    summary_file = 'summary_{}_{}{}.csv'.format(args.optimization, args.config_file, args.ext)
    ...
    if args.masked_retrain:
        ...
        for epoch in range(1, args.retrain_epoch+1):
            ...
            ### todo: modify, whether needed
            if output_dir is not None:
                summary_file = 'summary_retrain_'+args.optimization+'_'+args.config_file+'.csv'
